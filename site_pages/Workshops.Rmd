...
### [Dynamic Visualization using Shiny](https://jacobtnyoung.github.io/dynamic-viz/)

I also teach a workshop that introduces participants to dynamic visualization using RStudio and Shiny. We focus on how to build interactive dashboards and leverage generative AI for advanced features. By the end of the workshop, attendees deploy their own web-based dashboard.
...
This "crash course" provides an introduction to these various ideas and techniques. Slides from the most recent workshop are available [here](https://github.com/jacobtnyoung/jacobtnyoung.github.io/raw/master/_workshops/Networks-Crash-Course-SLIDES.pdf).
